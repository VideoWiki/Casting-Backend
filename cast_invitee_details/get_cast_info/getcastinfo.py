...
class GetCastInformation(APIView):
    ...
    def get(self, request):
        ...
        if response.status_code != requests.codes.ok:
            ...
            full_info = request.GET.get("full_info")
            try:
                ...
                if cast_object.meeting_type == 'public':
                    ...
                    for i in cast_invite_object:
                        ...
                        if i.role == 'co-host':
                            ...
                            join_data["spectator_url"] = CLIENT_DOMAIN_URL + "/live/{}".format(
                                cast_object.public_meeting_id)
                        join_urls.append(join_data)
