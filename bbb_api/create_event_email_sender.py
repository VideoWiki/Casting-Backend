...
def attendee_mail(invitee_name, email, event_name, time, meeting_url, attendee_password, stream_url):
    ...
    if stream_url != "":
        ...
        text = "Dear {}, <br>You have been invited to join a cast '{}'. <br>The cast will begin at {} UTC. <br>Your cast url is {}. <br>Please provide your name and following password: {}. <br>Don't miss it!".format(invitee_name, event_name, time, meeting_url, attendee_password)
    status_res = send_mail(email, name, subject, global_merge_vars, text)
    status = status_res
    return status
