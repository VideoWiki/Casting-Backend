...
class Meeting(models.Model):
    ...
    hashed_attendee_password = models.CharField(max_length=100, null=True, blank=True)
    moderator_password = models.CharField(max_length=50)
    hashed_moderator_password = models.CharField(max_length=100, null=True, blank=True)
    viewer_password = models.CharField(max_length=50)
    hashed_viewer_password = models.CharField(max_length=100, null=True, blank=True)
