...
def email_create4(user_name, event_name, event_time, event_url, meeting_url, nft_drop_url, moderator_password, attendee_password, pre_reg_url):
    template_part1 = """\
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    """.format(user_name, event_name, event_time, event_url, meeting_url, nft_drop_url, moderator_password, attendee_password, CLIENT_DOMAIN_URL, pre_reg_url)
